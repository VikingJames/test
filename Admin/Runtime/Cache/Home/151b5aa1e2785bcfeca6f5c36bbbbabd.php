...
<html lang="zh-cn">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="/acephp/Public/assets/css/ace.min.css" id="main-ace-style" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="/acephp/Public/assets/css/ace-part2.min.css" />
		<![endif]-->
		<link rel="stylesheet" href="/acephp/Public/assets/css/ace-skins.min.css" />
		...
		<script src="/acephp/Public/assets/js/ace-extra.min.js"></script>
					...
					<ul class="nav ace-nav">
							...
							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li class="dropdown-content">
									<ul class="dropdown-menu dropdown-navbar">
										<li>
											<a href="#">
												<img src="/acephp/Public/assets/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
												<span class="msg-body">
										...
										<li>
											<a href="#">
												<img src="/acephp/Public/assets/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#">
												<img src="/acephp/Public/assets/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#">
												<img src="/acephp/Public/assets/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#">
												<img src="/acephp/Public/assets/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="/acephp/Public/assets/avatars/user.jpg" alt="Jason's Photo" />
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					<li class="">
						<a data-url="page/index" href="?ajax.html#page/index">
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a data-url="page/users" href="?ajax.html#page/users">
							...
							<li class="">
								<a data-url="page/admins" href="?ajax.html#page/admins">
									<i class="menu-icon fa fa-caret-right"></i>
									系统管理员管理
								</a>
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							...
							<span class="menu-text">APP后台管理 </span>
						...
						<ul class="submenu">
							<li class="">
								<a data-url="page/map" href="?ajax.html#page/map">
									<i class="menu-icon fa fa-caret-right"></i>
									后台地图管理
								</a>
							...
							<li class="">
								<a data-url="page/appcontext" href="?ajax.html#page/appcontext">
									<i class="menu-icon fa fa-caret-right"></i>
									内容管理
								</a>
...
<![endif]-->
		...
		<script src="/acephp/Public/assets/js/bootstrap.min.js"></script>

		<!-- ace scripts -->
		<script src="/acephp/Public/assets/js/ace-elements.min.js"></script>
		<script src="/acephp/Public/assets/js/ace.min.js"></script>
		<script type="text/javascript">
					  ...
					  if('enable_ajax_content' in ace) {
						var options = {
						  content_url: function(url) {
							...
							var path = '/acephp'+'/Admin/Home/View/ace/'+url.replace(/^page\//, '')+'.html';
							//alert(path);
							return path;
							//for Ace HTML demo version, convert ajax.html#page/gallery to > gallery.html and load it
							//if(path.match(/Home\Manage\.html/)) return path.replace(/Home\Manage\.html/, url.replace(/^page\//, 'View/ace/')+'.html') ;
